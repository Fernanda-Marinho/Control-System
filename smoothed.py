...
tempo = data.iloc[:, tempo_col_index]
sensor1 = data.iloc[:, sensor1_col_index]
...
sensor1_suave = media_movel(sensor1, window_size)
...
sensor1_poly = polynomial_regression(tempo_numeric, sensor1_suave.fillna(0), degree)
